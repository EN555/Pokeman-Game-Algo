...
/**
 * This class represents the simplest "Client-Game" main class which uses the
 * "server for moving the "Agents". Note: this code is a very simple no
 * algorithm no threaded mechanism - it is presented just to show the basic use
 * of the "server".
 */
public class SimpleGameClient {
	...
	public static void test1() {
		...
		// game.login(12345); // please use your ID only as a key. uncomment this will
		// upload your results to the server
